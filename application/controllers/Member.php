...
{ 
    ...
    private function _login() 
    {
        ...
        { 
            ...
            { 
                ...
                { 
                    $data = [ 'email' => $user['email'], 'role_id' => $user['role_id'], 'id_user' => $user['id'], 'nama' => $user['nama'] ]; 
    ...
    { 
        ...
        $this->load->view('templates\templates-user\modal'); 
    ...
    { 
        ...
        { 
            ...
            { 
                ...
                $config['file_name'] = 'pro' . time(); $this->load->library('upload', $config); 
