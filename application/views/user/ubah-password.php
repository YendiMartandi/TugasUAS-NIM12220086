<!-- <div class="text-center text-primary font-weight-bold">
    <h1>INI HALAMAN UBAH PASSWORD</h1>
</div> -->

<!-- awal konten halaman -->
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-6"> <?= $this->session->flashdata('pesan'); ?> 
            <form action="<?= base_url('user/ubahPassword'); ?>" method="post">
                <div class="form-gorup"> <label for="password_sekarang">Password Saat ini</label> 
                ...
                <div class="form-gorup"> <label for="password_baru1">Password Baru</label> 
                ...
                <div class="form-gorup"> <label for="password_baru2">Ulangi Password </label> 
